...
// Cross Module References
	AKAUDIO_API UFunction* Z_Construct_UDelegateFunction_AkAudio_PostEventAtLocationAsyncCompleted__DelegateSignature();
...
// End Cross Module References
	struct Z_Construct_UDelegateFunction_AkAudio_PostEventAtLocationAsyncCompleted__DelegateSignature_Statics
	{
		struct _Script_AkAudio_eventPostEventAtLocationAsyncCompleted_Parms
		{
			int32 PlayingID;
		};
	...
	const UE4CodeGen_Private::FIntPropertyParams Z_Construct_UDelegateFunction_AkAudio_PostEventAtLocationAsyncCompleted__DelegateSignature_Statics::NewProp_PlayingID = { "PlayingID", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(_Script_AkAudio_eventPostEventAtLocationAsyncCompleted_Parms, PlayingID), METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UDelegateFunction_AkAudio_PostEventAtLocationAsyncCompleted__DelegateSignature_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UDelegateFunction_AkAudio_PostEventAtLocationAsyncCompleted__DelegateSignature_Statics::NewProp_PlayingID,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UDelegateFunction_AkAudio_PostEventAtLocationAsyncCompleted__DelegateSignature_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "Public/PostEventAtLocationAsync.h" },
	};
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UDelegateFunction_AkAudio_PostEventAtLocationAsyncCompleted__DelegateSignature_Statics::FuncParams = { (UObject*(*)())Z_Construct_UPackage__Script_AkAudio, nullptr, "PostEventAtLocationAsyncCompleted__DelegateSignature", nullptr, nullptr, sizeof(_Script_AkAudio_eventPostEventAtLocationAsyncCompleted_Parms), Z_Construct_UDelegateFunction_AkAudio_PostEventAtLocationAsyncCompleted__DelegateSignature_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_AkAudio_PostEventAtLocationAsyncCompleted__DelegateSignature_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00130000, 0, 0, METADATA_PARAMS(Z_Construct_UDelegateFunction_AkAudio_PostEventAtLocationAsyncCompleted__DelegateSignature_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_AkAudio_PostEventAtLocationAsyncCompleted__DelegateSignature_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UDelegateFunction_AkAudio_PostEventAtLocationAsyncCompleted__DelegateSignature()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UDelegateFunction_AkAudio_PostEventAtLocationAsyncCompleted__DelegateSignature_Statics::FuncParams);
		}
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UPostEventAtLocationAsync_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UPostEventAtLocationAsync_PollPostEventFuture, "PollPostEventFuture" }, // 820099611
		{ &Z_Construct_UFunction_UPostEventAtLocationAsync_PostEventAtLocationAsync, "PostEventAtLocationAsync" }, // 1625913309
	};
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FMulticastDelegatePropertyParams Z_Construct_UClass_UPostEventAtLocationAsync_Statics::NewProp_Completed = { "Completed", nullptr, (EPropertyFlags)0x0010000010080000, UE4CodeGen_Private::EPropertyGenFlags::InlineMulticastDelegate, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UPostEventAtLocationAsync, Completed), Z_Construct_UDelegateFunction_AkAudio_PostEventAtLocationAsyncCompleted__DelegateSignature, METADATA_PARAMS(Z_Construct_UClass_UPostEventAtLocationAsync_Statics::NewProp_Completed_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UPostEventAtLocationAsync_Statics::NewProp_Completed_MetaData)) };
	...
	IMPLEMENT_CLASS(UPostEventAtLocationAsync, 1430567919);
