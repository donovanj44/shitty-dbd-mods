...
static struct FScriptStruct_AkAudio_StaticRegisterNativesFAkWinGDKAdvancedInitializationSettings
{
	...
	{
		UScriptStruct::DeferCppStructOps(FName(TEXT("AkWinGDKAdvancedInitializationSettings")),new UScriptStruct::TCppStructOps<FAkWinGDKAdvancedInitializationSettings>);
	}
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FAkWinGDKAdvancedInitializationSettings_Statics::NewProp_UseHeadMountedDisplayAudioDevice = { "UseHeadMountedDisplayAudioDevice", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FAkWinGDKAdvancedInitializationSettings), &Z_Construct_UScriptStruct_FAkWinGDKAdvancedInitializationSettings_Statics::NewProp_UseHeadMountedDisplayAudioDevice_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FAkWinGDKAdvancedInitializationSettings_Statics::NewProp_UseHeadMountedDisplayAudioDevice_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAkWinGDKAdvancedInitializationSettings_Statics::NewProp_UseHeadMountedDisplayAudioDevice_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FAkWinGDKAdvancedInitializationSettings_Statics::NewProp_GlobalFocus_MetaData[] = {
		{ "Category", "AkWinGDKAdvancedInitializationSettings" },
		{ "ModuleRelativePath", "Public/AkWinGDKAdvancedInitializationSettings.h" },
	};
#endif
	void Z_Construct_UScriptStruct_FAkWinGDKAdvancedInitializationSettings_Statics::NewProp_GlobalFocus_SetBit(void* Obj)
	{
		((FAkWinGDKAdvancedInitializationSettings*)Obj)->GlobalFocus = 1;
	}
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FAkWinGDKAdvancedInitializationSettings_Statics::NewProp_GlobalFocus = { "GlobalFocus", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FAkWinGDKAdvancedInitializationSettings), &Z_Construct_UScriptStruct_FAkWinGDKAdvancedInitializationSettings_Statics::NewProp_GlobalFocus_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FAkWinGDKAdvancedInitializationSettings_Statics::NewProp_GlobalFocus_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAkWinGDKAdvancedInitializationSettings_Statics::NewProp_GlobalFocus_MetaData)) };
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FAkWinGDKAdvancedInitializationSettings_Statics::NewProp_AudioAPI_MetaData[] = {
		{ "Category", "AkWinGDKAdvancedInitializationSettings" },
		{ "ModuleRelativePath", "Public/AkWinGDKAdvancedInitializationSettings.h" },
	};
#endif
	const UE4CodeGen_Private::FUInt32PropertyParams Z_Construct_UScriptStruct_FAkWinGDKAdvancedInitializationSettings_Statics::NewProp_AudioAPI = { "AudioAPI", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::UInt32, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FAkWinGDKAdvancedInitializationSettings, AudioAPI), METADATA_PARAMS(Z_Construct_UScriptStruct_FAkWinGDKAdvancedInitializationSettings_Statics::NewProp_AudioAPI_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAkWinGDKAdvancedInitializationSettings_Statics::NewProp_AudioAPI_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UScriptStruct_FAkWinGDKAdvancedInitializationSettings_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FAkWinGDKAdvancedInitializationSettings_Statics::NewProp_GlobalFocus,
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FAkWinGDKAdvancedInitializationSettings_Statics::NewProp_AudioAPI,
	};
	...
	uint32 Get_Z_Construct_UScriptStruct_FAkWinGDKAdvancedInitializationSettings_Hash() { return 3568690481U; }
