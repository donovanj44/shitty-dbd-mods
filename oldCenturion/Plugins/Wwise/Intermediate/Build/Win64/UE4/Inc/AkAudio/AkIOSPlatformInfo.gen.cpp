...
#include "AkAudio/Public/AkIOSPlatformInfo.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// End Cross Module References
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UAkIOSPlatformInfo_Statics::Class_MetaDataParams[] = {
		{ "IncludePath", "AkIOSPlatformInfo.h" },
		{ "ModuleRelativePath", "Public/AkIOSPlatformInfo.h" },
	};
#endif
	...
	IMPLEMENT_CLASS(UAkIOSPlatformInfo, 2696507999);
	template<> AKAUDIO_API UClass* StaticClass<UAkIOSPlatformInfo>()
	{
		return UAkIOSPlatformInfo::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_UAkIOSPlatformInfo(Z_Construct_UClass_UAkIOSPlatformInfo, &UAkIOSPlatformInfo::StaticClass, TEXT("/Script/AkAudio"), TEXT("UAkIOSPlatformInfo"), false, nullptr, nullptr, nullptr);
