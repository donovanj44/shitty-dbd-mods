...
#include "AkAudio/Public/AkAndroidPlatformInfo.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// End Cross Module References
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UAkAndroidPlatformInfo_Statics::Class_MetaDataParams[] = {
		{ "IncludePath", "AkAndroidPlatformInfo.h" },
		{ "ModuleRelativePath", "Public/AkAndroidPlatformInfo.h" },
	};
#endif
	...
	IMPLEMENT_CLASS(UAkAndroidPlatformInfo, 518277167);
	template<> AKAUDIO_API UClass* StaticClass<UAkAndroidPlatformInfo>()
	{
		return UAkAndroidPlatformInfo::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_UAkAndroidPlatformInfo(Z_Construct_UClass_UAkAndroidPlatformInfo, &UAkAndroidPlatformInfo::StaticClass, TEXT("/Script/AkAudio"), TEXT("UAkAndroidPlatformInfo"), false, nullptr, nullptr, nullptr);
