...
// End Cross Module References
	...
	uint32 Get_Z_Construct_UEnum_AkAudio_AkSpeakerConfiguration_Hash() { return 397373517U; }
	UEnum* Z_Construct_UEnum_AkAudio_AkSpeakerConfiguration()
	{
		...
		if (!ReturnEnum)
		{
			static const UE4CodeGen_Private::FEnumeratorParam Enumerators[] = {
				...
				{ "AkSpeakerConfiguration::Ak_Speaker_MAX", (int64)AkSpeakerConfiguration::Ak_Speaker_MAX },
			};
#if WITH_METADATA
			const UE4CodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
				...
				{ "Ak_Speaker_MAX.Hidden", "" },
				{ "Ak_Speaker_MAX.Name", "AkSpeakerConfiguration::Ak_Speaker_MAX" },
