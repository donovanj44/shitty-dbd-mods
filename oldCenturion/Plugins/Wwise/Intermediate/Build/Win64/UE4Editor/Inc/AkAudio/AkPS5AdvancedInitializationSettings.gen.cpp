...
static struct FScriptStruct_AkAudio_StaticRegisterNativesFAkPS5AdvancedInitializationSettings
{
	...
	{
		UScriptStruct::DeferCppStructOps(FName(TEXT("AkPS5AdvancedInitializationSettings")),new UScriptStruct::TCppStructOps<FAkPS5AdvancedInitializationSettings>);
	}
	...
	const UE4CodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FAkPS5AdvancedInitializationSettings_Statics::NewProp_UseHardwareCodecLowLatencyMode = { "UseHardwareCodecLowLatencyMode", nullptr, (EPropertyFlags)0x0010000000000001, UE4CodeGen_Private::EPropertyGenFlags::Bool | UE4CodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, sizeof(bool), sizeof(FAkPS5AdvancedInitializationSettings), &Z_Construct_UScriptStruct_FAkPS5AdvancedInitializationSettings_Statics::NewProp_UseHardwareCodecLowLatencyMode_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FAkPS5AdvancedInitializationSettings_Statics::NewProp_UseHardwareCodecLowLatencyMode_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAkPS5AdvancedInitializationSettings_Statics::NewProp_UseHardwareCodecLowLatencyMode_MetaData)) };
	...
	uint32 Get_Z_Construct_UScriptStruct_FAkPS5AdvancedInitializationSettings_Hash() { return 867041340U; }
