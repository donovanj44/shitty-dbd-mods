...
void EmptyLinkFunctionForGeneratedCodeDBDInteraction_init() {}
	...
	UPackage* Z_Construct_UPackage__Script_DBDInteraction()
	{
		...
		if (!ReturnPackage)
		{
			static UObject* (*const SingletonFuncArray[])() = {
				(UObject* (*)())Z_Construct_UDelegateFunction_DBDInteraction_CollectItemInteractionOnCollectUpdateStart__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_DBDInteraction_CollectItemInteractionOnCollectUpdateEnd__DelegateSignature,
			};
			static const UE4CodeGen_Private::FPackageParams PackageParams = {
				"/Script/DBDInteraction",
				SingletonFuncArray,
