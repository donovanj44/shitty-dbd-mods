...
void EmptyLinkFunctionForGeneratedCodeGFXUtilities_init() {}
	...
	UPackage* Z_Construct_UPackage__Script_GFXUtilities()
	{
		...
		if (!ReturnPackage)
		{
			static UObject* (*const SingletonFuncArray[])() = {
				(UObject* (*)())Z_Construct_UDelegateFunction_GFXUtilities_LightIntensityTimelineComponentOnTimelineFinished__DelegateSignature,
			};
