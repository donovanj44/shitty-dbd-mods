...
void EmptyLinkFunctionForGeneratedCodeTheBlight_init() {}
	...
	UPackage* Z_Construct_UPackage__Script_TheBlight()
	{
		...
		if (!ReturnPackage)
		{
			static UObject* (*const SingletonFuncArray[])() = {
				(UObject* (*)())Z_Construct_UDelegateFunction_TheBlight_BlightPowerStateComponentOnPowerCollided__DelegateSignature,
			};
